...
import '@/app/sign-log/Logsign.css';
...
const LogSign: React.FC = () => {
    ...
    const fulltext: string = "Weelcome to the future of Education..."

    useEffect(() => {
        let ind = 0
        const typeinterval = setInterval(() => {
            if (ind < fulltext.length) {
                setText((prev) => prev + fulltext.charAt(ind))
                ind++
            } else {
    ...
    return (
        <div className="logmain mt-1">
            <svg width="134" height="33" viewBox="0 0 134 33" fill="none" xmlns="http://www.w3.org/2000/svg" className='mt-2 '>
            ...
            <div className='logsign-container flex flex-wrap justify-between items-center'>
                <div className='left-half flex-1 flex flex-col justify-center items-center'>
                    <div className="sm:text-4xl md:text-4xl lg:text-5xl uppercase font-bold text-white text-center mt-10 txt-box">
                        <span className='typing'>{text}</span>
                    </div>
                    <div className="triangle"></div>
                    <div id="sketch-board-con" className=' justify-center flex'>
                        <div id="sketch-board">
                            <div id="head">
                                <div id="lens">
                ...
                <div className='right-half flex-1 flex justify-center items-center text-white'>
                                    ...
                                    <div className="section pb-5 pt-5 pt-sm-2 text-center">
                                        ...
                                        <div className="card-3d-wrap mx-auto">
                                            <div className="card-3d-wrapper">
                                                <div className={`card-front ${isSignUp ? 'd-none' : ''}`}>
                                                    <div className="center-wrap">
                                                        <div className="section text-center">
                                                            <h4 className="mb-4 pb-3 text-2xl">Log In</h4>
                                                            <div className="social-container mb-2">
                                                                <a href="#" className="social hover:bg-blue-900"><FontAwesomeIcon icon={faFacebookF} /></a>
                                                                <a onClick={handleGoogleSign} className="social hover:bg-red-700"><FontAwesomeIcon icon={faGooglePlusG} /></a>
                                                                <a href="#" className="social hover:bg-blue-800"><FontAwesomeIcon icon={faLinkedinIn} /></a>
                                                            </div>
                                                ...
                                                <div className={`card-back ${isSignUp ? '' : 'd-none'}`}>
                                                    <div className="center-wrap">
                                                        <div className="section text-center">
